            ...
            <div class="sidebar pe-4 pb-3 admin-dashboard-nav" style="background-color: #172238;">
                <nav class="navbar">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="teacherAssingments.php" class="nav-item nav-link active"><i class="fa-solid fa-square-poll-vertical me-2"></i>Assingments</a>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="col-12 ms-2 p-0">
                                            ...
                                            if ($lesson_data['lesson_id']) {
                                                ...
                                                $lesson_note_rs = Database::search("SELECT * FROM `assingments`
                                            ...
                                            ?>
                                                    ...
                                                    <div class="col-12 border row p-0 rounded bg-warning">
                                                        <div class="col-12 pt-3">
                                                            <p class="fs-4"><?php echo $lesson_note_data["assingment_name"] ?></p>
                                                        </div>
                                                    </div>
                                            <?php
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="uploadAssingments(<?php echo $lesson_data['lesson_id']; ?>);">Upload File</button>
                                    </div>
                                </div>
                            </div>
                        </div>
