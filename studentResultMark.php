                ...
                <div class="content">
                    ...
                    <div class="container-fluid pt-4 px-4">
                        ...
                        if ($mark_id) {
                            ...
                            $lessons_rs = Database::search("SELECT * FROM `lessons`
                            INNER JOIN `student_answers` ON
                            lessons.lesson_id=student_answers.lessons_lesson_id
                            INNER JOIN `student_mark` ON
                            student_answers.id=student_mark.student_answers_id  
                            WHERE `lesson_id`='" . $mark_id . "'");
                            $lessons_num = $lessons_rs->num_rows;

                            for ($x = 0; $x < $lessons_num; $x++) {
                                $lessons_data = $lessons_rs->fetch_assoc();

                        ?>
                                <div class="grade-result-box">
                                    <div class="col-12 row">
                                        <div class="col-8">
                                            <p><?php echo $lessons_data["student_registration_email"]; ?></p>
                                        </div>
                                        <div class="col-2">
                                            <p><?php echo $lessons_data["assingments_name"]; ?></p>
                                        </div>
                                        <div class="col-2">
                                            <p>Mark :<?php echo $lessons_data["mark"]; ?></p>
                                        </div>
                                    </div>
                                </div>
                        <?php
