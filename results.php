            ...
            <div class="sidebar pe-4 pb-3 admin-dashboard-nav" style="background-color: #172238;">
                <nav class="navbar">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="#" class="nav-item nav-link active"><i class="fa-solid fa-square-poll-vertical me-2"></i>Results</a>
                    ...
                    ?>
                        <div class="grade-result-box">
                            <div class="col-12 row">
                                <div class="col-10">
                                    <p><?php echo $grade_data["grade_name"]; ?></p>
                                </div>
                                <div class="col-2">
                                    <a href="<?php echo "subject.php?id=" . $grade_data["id"]; ?>" class="btn btn-primary col-12">Details</a>
                                </div>
                            </div>
                        </div>
                    <?php
