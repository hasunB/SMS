            ...
            <div class="sidebar pe-4 pb-3 admin-dashboard-nav" style="background-color: #172238;">
                <nav class="navbar">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="AOPanel.php" class="nav-item nav-link active"><i class="fa-solid fa-chart-line me-2"></i>Dashboard</a>
                ...
                <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="col-12 row my-profile-2">
                        <div class="col-12 mt-5 mb-3 row">
                            <div class="col-6 d-flex justify-content-center align-items-center">
                                <div class="col-12">
                                    <div class="col-12  d-flex justify-content-center align-items-center">
                                        ...
                                        ?>
                                            <img src="<?php echo $ao_img_data["path"]; ?>" class="rounded-circle" width="200px" height="200px" id="img">
                                        <?php
                                        }
                            ...
                            <div class="col-6">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control border border-warning" value="<?php echo $academicOfiicer_data["first_name"]; ?>" id="fname" />
                                </div>
                                <div class="col-12 mt-4">
                                    <label class="form-label ps-1 fw-bold">Middle Name</label>
                                    <input type="text" class="form-control border border-warning" value="<?php echo $academicOfiicer_data["middle_name"]; ?>" id="mname" />
                                </div>
                                <div class="col-12 mt-4">
                                    <label class="form-label ps-1 fw-bold">Last Name</label>
                                    <input type="text" class="form-control border border-warning" value="<?php echo $academicOfiicer_data["last_name"]; ?>" id="lname" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="col-12 mt-4">
                                    <div class="col-12 row p-0">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control border border-warning text-black-50" value="<?php echo $academicOfiicer_data["email"]; ?>" id="" disabled />
                                        </div>
                                        <div class="col-6 ps-0">
                                            <label class="form-label ps-1 ms-4 fw-bold">Password</label>
                                            <input type="text" class="form-control border border-warning ms-4 text-black-50" value="<?php echo $academicOfiicer_data["password"]; ?>" id="" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mt-4">
                                    <div class="col-12 row p-0">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control border border-warning" value="<?php echo $academicOfiicer_data["contact_no"]; ?>" id="mobile" />
                                        </div>
                                        <div class="col-6 ps-0">
                                            <label class="form-label ps-1 ms-4 fw-bold">NIC</label>
                                            <input type="text" class="form-control border border-warning ms-4 text-black-50" value="<?php echo $academicOfiicer_data["nic"]; ?>" id="" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mt-4">
                                    <div class="col-12 row p-0">
                                        <div class="col-6">
                                            <label class="form-label ps-1 fw-bold">Grade</label>
                                            <input type="text" class="form-control border border-warning text-black-50" value="<?php echo $academicOfiicer_data["grade_id"]; ?>" disabled />
                                        </div>
                                        <div class="col-6 ps-0">
                                            <label class="form-label ps-1 ms-4 fw-bold">Gender</label>
                                            <input type="text" class="form-control border border-warning ms-4 text-black-50" value="<?php echo $academicOfiicer_data["gender_name"]; ?>" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 row mb-4 mt-4">
                            <div class="col-12 d-flex justify-content-center align-items-center">
                                <button class="btn btn-success col-8 fw-bold" onclick="updateAcademicOfficerProfile();"><i class="bi bi-arrow-up-circle"></i>&nbsp;Update Profile</button>
                            </div>
                        </div>
                    </div>
                </div>
