...
<body class="teacher-main-body">
    <div class="container">
        <div class="row">
            <div class="col-md-6 align-self-center">
                <div class="left-content">
                    <h2>Registration for Teachers</h2>
                    <h3>Let's make a better place to <em>learn our students</em></h3>
                </div>
            </div>
            <div class="col-md-6">
                <form id="contact" class="form-input">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <fieldset>
                                <button onclick="teacherRegistration();">Register</button>
                            </fieldset>
                        </div>
                    </div>
                </form>
    ...
    <!-- model -->
    <div class="modal fade" tabindex="-1" id="teacherregmodel">
