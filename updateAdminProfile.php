...
if (isset($_SESSION["ad"])) {
    ...
    $admin_rs = Database::search("SELECT * FROM `admin` INNER JOIN `gender` ON 
    admin.gender_id=gender.id WHERE `email`='" . $ad_data . "'");
                ...
                <div class="container-fluid pt-4 px-4">
                    ...
                    <div class="col-12 row my-profile-2">
                        <div class="col-12 mt-5 mb-3 row">
                            <div class="col-6 d-flex justify-content-center align-items-center">
                                <div class="col-12">
                                    <div class="col-12  d-flex justify-content-center align-items-center">
                                        ...
                                        if (empty($admin_img_data["path"])) {
                                        ?>
                                            <img src="assets/images/man.jpg" class="rounded-circle" width="200px" height="200px" id="img">
                                        <?php
                                        } else {
                                        ?>
                                            <img src="<?php echo $admin_img_data["path"]; ?>" class="rounded-circle" width="200px" height="200px" id="img">
                                        <?php
                                        }
                            ...
                            <div class="col-6">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control border border-warning" value="<?php echo $admin_data["first_name"]; ?>" id="fname" />
                                </div>
                                <div class="col-12 mt-4">
                                    <label class="form-label ps-1 fw-bold">Last Name</label>
                                    <input type="text" class="form-control border border-warning" value="<?php echo $admin_data["last_name"]; ?>" id="lname" />
                                </div>
                                <div class="col-12 mt-4">
                                    <label class="form-label ps-1 fw-bold">Mobile</label>
                                    <input type="text" class="form-control border border-warning" value="<?php echo $admin_data["mobile"]; ?>" id="mobile" />
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="col-12 mt-4">
                                    <div class="col-12 row p-0">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control border border-warning text-black-50" value="<?php echo $admin_data["email"]; ?>" id="" disabled />
                                        </div>
                                        <div class="col-6 ps-0">
                                            <label class="form-label ps-1 ms-4 fw-bold">Password</label>
                                            <input type="text" class="form-control border border-warning ms-4 text-black-50" value="<?php echo $admin_data["password"]; ?>" id="" disabled />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 mt-4">
                                    <div class="col-12 row p-0">
                                        <div class="col-6">
                                            ...
                                            <input type="text" class="form-control border border-warning text-black-50" value="<?php echo $admin_data["gender_name"]; ?>" id="" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 row mb-4 mt-4">
                            <div class="col-12 d-flex justify-content-center align-items-center">
                                <button class="btn btn-success col-8 fw-bold" onclick="updateAdminProfile();"><i class="bi bi-arrow-up-circle"></i>&nbsp;Update Profile</button>
                            </div>
                        </div>
                    </div>
                </div>
