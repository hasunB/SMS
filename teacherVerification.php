                ...
                <div class="row">
                    <div class="col-12  signin" id="signInBox">
                        ...
                        <div class="form-floating col-lg-12 col-10 col-md-12 ms-4 ms-lg-0 ms-md-0">
                            <input type="email" class="form-control" placeholder="name@example.com" id="temail">
                            <label for="floatingInput">Email address</label>
                        </div>
                        <div class="form-floating mt-3 col-lg-12 col-10 col-md-12 ms-4 ms-lg-0 ms-md-0">
                            <input type="password" class="form-control" placeholder="Password" id="tpw">
                            <label for="floatingPassword">Password</label>
                        </div>
                        <div class="form-floating mt-3 col-lg-12 col-10 col-md-12 ms-4 ms-lg-0 ms-md-0">
                            <input type="text" class="form-control" placeholder="Code" id="tvcode">
                            <label for="floatingPassword">Verification Code</label>
                        </div>
                        <button type="submit" onclick="teacherVerification();">Verify</button>
                    </div>
                </div>
            </div>
            <!-- content -->
