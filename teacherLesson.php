            ...
            <div class="sidebar pe-4 pb-3 admin-dashboard-nav" style="background-color: #172238;">
                <nav class="navbar">
                    ...
                    <div class="navbar-nav w-100">
                        ...
                        <a href="teacherLesson.php" class="nav-item nav-link active"><i class="fa-solid fa-chalkboard-user me-2"></i>Lessons</a>
                    ...
                    ?>
                        <div class="grade-result-box">
                            <div class="col-12 row">
                                ...
                                <div class="col-2">
                                    <a class="btn btn-primary col-12" onclick="addLessonNotes();"><i class="bi bi-file-earmark-plus"></i></a>
                                </div>
                            </div>
                        </div>
                        <!-- Model -->
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Add Lessons Notes</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="col-12 ms-2 p-0">
                                            ...
                                            if ($lesson_data['lesson_id']) {
                                                ...
                                                $lesson_note_rs = Database::search("SELECT * FROM `lesson_notes`
                                            ...
                                            ?>
                                                    ...
                                                    <div class="col-12 border row p-0 rounded bg-warning">
                                                        <div class="col-12 pt-3">
                                                            <p class="fs-4"><?php echo $lesson_note_data["file_name"] ?></p>
                                                        </div>
                                                    </div>
                                            <?php
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="uploadLessonNote(<?php echo $lesson_data['lesson_id']; ?>);">Upload File</button>
                                    </div>
                                </div>
                            </div>
                        </div>
